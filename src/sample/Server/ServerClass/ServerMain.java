...
public class ServerMain extends Application {
    ...
    public void start(Stage startingStage) throws Exception {
        FXMLLoader loaderServerStartingScreen = new FXMLLoader(getClass().getResource("/sample/Server/ServerFXML/ServerGraphics.fxml"));//creo un nuovo FMXLLoader passandogli il .fxml
        ...
        startingStage.getIcons().add(new Image("/sample/Server/ServerImage/Icona.png"));//Icona della finestra
        ...
        startingScene.getStylesheets().add(getClass().getResource("/sample/Server/ServerCSS/Style.css").toExternalForm());//collegare il .css (ad esempio) per l'aggiunta del background
    ...
    public void openNewWindow(){
        try{
            FXMLLoader loaderServerClientCounterScreen = new FXMLLoader(getClass().getResource("/sample/Server/ServerFXML/ContatoreClient.fxml"));//carico .fxml
            ...
            clientCounterStage.getIcons().add(new Image("/sample/Server/ServerImage/IconaClient.png"));//icona della finestra
            ...
            clientCounterScene.getStylesheets().add(getClass().getResource("/sample/Server/ServerCSS/StyleCounter.css").toExternalForm());//collegare il .css (ad esempio) per l'aggiunta del background
