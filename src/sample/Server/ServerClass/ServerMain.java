...
public class ServerMain extends Application {
    ...
    public void start(Stage startingStage) throws Exception {
        ...
        startingStage.getIcons().add(new Image(startingScreenIcon));//Icona della finestra
        ...
        startingScene.getStylesheets().add(getClass().getResource(startingScreenCSS).toExternalForm());//collegare il .css (ad esempio) per l'aggiunta del background
    ...
    public void openNewWindow(){
        try{
            FXMLLoader loaderServerClientCounterScreen = new FXMLLoader(getClass().getResource(clientCounterScreenFXML));//carico .fxml
            ...
            clientCounterStage.getIcons().add(new Image(clientCounterScreenIcon));//icona della finestra
            ...
            clientCounterScene.getStylesheets().add(getClass().getResource(clientCounterScreenCSS).toExternalForm());//collegare il .css (ad esempio) per l'aggiunta del background
